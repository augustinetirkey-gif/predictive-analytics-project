...
# --- NEW TWO-COLUMN SIDEBAR ---
    ...
    with col_past:
        ...
        # List of years from your uploaded data
    ...
    with col_future:
        ...
        # List of years generated by the AI (2006-2010)
    ...
    # Combine both selections for the final data filter
    ...
    # Update the filter logic to use 'selected_years'
    df = df_master[
